...
- [Profile](#section-rateprofile): Profile specific variables, affecting only the active profile.
- [Rate Profile](#section-profile): Rate specific variables, affecting only the active rate profile.
